...
if __name__ == '__main__':
    ...
    n_runs=args.n_runs
    ent_m=torch.zeros(n_runs,device='cpu')
    density_m=torch.zeros([n_runs,len(q_list),n_s],device='cpu')
    error_m = torch.zeros([n_runs,len(q_list),n_s],device='cpu')
    error_super_m = torch.zeros([n_runs, len(q_list),n_s],device='cpu')
